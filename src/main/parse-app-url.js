...
function parseAppURL(url) {
  ...
  if (
    pathname &&
    CONFIG.main.implicitReturnPath &&
    pathname.toLowerCase().includes(CONFIG.main.implicitReturnPath)
  ) {
    actionName = CONFIG.main.implicitReturnPath;
  } else if (
    hostname &&
    CONFIG.main.implicitReturnPath &&
    hostname.toLowerCase().includes(CONFIG.main.implicitReturnPath)
  ) {
    actionName = CONFIG.main.implicitReturnPath;
  }
  ...
  // Start of actionName === CONFIG.main.implicitReturnPath section
  ...
  // End of actionName === CONFIG.main.implicitReturnPath section
